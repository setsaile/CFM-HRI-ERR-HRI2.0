...
# 设置模型保存路径
original_model_path = "./BASE/models/clf_ch2_minirocket_win5_stri1.pkl"
filtered_model_path = "./BASE/models/clf_ch2_minirocket_win5_stri1_filtered.pkl"
...
pred_test_df.to_csv("./BASE/result/y_pred_ch2_w5_s1_minirocket.csv", index=False)
