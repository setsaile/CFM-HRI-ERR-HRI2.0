...
# print(" done.")
model_path = "./BASE/models/clf_ch1_minirocket_win3_stri0.5.pkl"
...
probs_reaction_test = clf_err.predict_proba(X_test)[:, 1]
...
pred_test_df.to_csv("./BASE/result/y_pred_ch1_w3_s0.5_minirocket.csv", index = False)
