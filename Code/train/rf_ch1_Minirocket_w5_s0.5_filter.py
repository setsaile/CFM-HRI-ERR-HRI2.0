...
# 设置模型保存路径
original_model_path = "./BASE/models/clf_ch1_newminirocket_win5_stri0.5.pkl"
filtered_model_path = "./BASE/models/clf_ch1_minirocket_w5_s0.5_k10000.pkl"
...
# 预测验证集
print("在验证集上进行预测...")
probs_err = clf_err.decision_function(X_val_reshaped)
# probs_err = expit(scores_err)  # 或直接使用 scores_err 也可以
...
# pred_test_df.to_csv("./BASE/result/y_pred_ch1_w5_s0.5_minirocket_best.csv", index=False)
