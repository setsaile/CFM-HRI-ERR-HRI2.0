...
def process_all_data(WINDOW_SIZE, STRIDE, is_test):
    ...
    for system, tasks in SYSTEMS.items():
        ...
        for task in tasks:
            ...
            labels, robot_errors, human_reactions_ch1, human_reactions_ch2 = load_and_preprocess_labels(task,is_test=True)
            ...
            for face_file in sorted(face_files):
                ...
                try:
                    ...
                    # Extract windows
                    windows = extract_windows(face_df, audio_df, transcript_df, trial_name, robot_errors, human_reactions_ch1, human_reactions_ch2, WINDOW_SIZE, STRIDE,is_test=True)                    
...
def main():
    windows = process_all_data(WINDOW_SIZE, STRIDE, is_test = True)
